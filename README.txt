...
WHAT IT IS
A private app, just for you, that shows the market honestly:
  • Buy/sell signals, backtested on 10 years of real history
  • Every stock scored for steadiness (with plain-English explanations)
...
ADDING / REMOVING STOCKS
  • Add: double-click "Add-Stock.cmd" and type a ticker (e.g. TSLA).
  • Remove or reorder: edit "watchlist.txt" (one ticker per line).
...
THE FILES (you don't need to touch these)
  ...
  *.js .................. the latest fetched data

This is financial education, not advice, and never a guarantee.
Built for one user — you, the risk holder.
